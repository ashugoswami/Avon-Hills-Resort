        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-600 mb-4 sm:mb-6 max-w-sm">
              Experience luxury living in the heart of nature at Avon Hills Resort. Our premium spaces blend comfort,
              sustainability, and breathtaking views.
            </p>
            <div className="flex space-x-4">
              <Link href="https://www.facebook.com/avonhillsressort/" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="outline"
                  size="icon"
              ...
              <Link href="https://www.instagram.com/avon_hills_ressort/" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="outline"
                  size="icon"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#1B4332]">Quick Links</h3>
          ...
          {/* Contact Information */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#1B4332]">Contact Us</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li className="flex items-start transition-transform duration-300 hover:translate-x-2">
                <span className="text-[#1B4332] mr-2">📍</span>
                <span className="text-gray-600">Rajaji National Park, Near Dehradun</span>
              </li>
              <li className="flex items-start transition-transform duration-300 hover:translate-x-2">
                <span className="text-[#1B4332] mr-2">📞</span>
                <span className="text-gray-600">+91 706-574-5656</span>
              </li>
              <li className="flex items-start transition-transform duration-300 hover:translate-x-2">
                <span className="text-[#1B4332] mr-2">✉️</span>
                <span className="text-gray-600">info@avonhillsresort.com</span>
              </li>
            </ul>
          </div>
          ...
          {/* Newsletter Signup */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#1B4332]">Newsletter</h3>
            ...
            <form className="space-y-2">
              <input
                ...
                required
              />
              <Button type="submit" className="w-full bg-[#1B4332] hover:bg-[#2D6A4F] transition-all duration-300">
                Subscribe
              </Button>
            </form>
          </div>
